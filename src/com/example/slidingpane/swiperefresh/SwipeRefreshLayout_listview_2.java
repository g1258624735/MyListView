...
import com.example.slidingpane.R.layout;
 ...
 * @param <mProgressBar>
 */
public class SwipeRefreshLayout_listview_2<mProgressBar> extends ViewGroup
	...
	private Animation mShrinkTrigger = new Animation() {
		...
		public void applyTransformation(float interpolatedTime, Transformation t) {
			...
			Log.i("mProgressBar-mFromPercentage--", percent + "");
		}
	};
	...
	public void setLoadMore(loadMoreInface mloadMoreInface) {
		...
		((ListView) getChildAt(0)).setOnScrollListener(this);
	}
	...
	public SwipeRefreshLayout_listview_2(Context context) {
		this(context, null);
	}
	 ...
	 * @param attrs
	 */
	public SwipeRefreshLayout_listview_2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (firstVisibleItem + visibleItemCount == totalItemCount) {
			if (!hasFooter) {
				if (mloadMoreInface != null) {
					mloadMoreInface.loadMore();
				}
				((ListView) getChildAt(0)).addFooterView(footer);
				hasFooter = true;
			}
		}
	}
	...
	public void stopLoadMore() {
		((ListView) getChildAt(0)).removeFooterView(footer);
		hasFooter = false;
	}
}