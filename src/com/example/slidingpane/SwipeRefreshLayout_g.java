 ...
 * @param <mProgressBar>
 */
public class SwipeRefreshLayout_g<mProgressBar> extends ViewGroup {
    ...
    private SwipeProgressBar_ mProgressBar; //the thing that shows progress is going
    ...
    public SwipeRefreshLayout_g(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeRefreshLayout_g(Context context, AttributeSet attrs) {
        super(context, attrs);
