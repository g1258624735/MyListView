 ...
 */
public class SlidingPaneLayout_g extends ViewGroup {
    ...
    public SlidingPaneLayout_g(Context context) {
        this(context, null);
    }

    public SlidingPaneLayout_g(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingPaneLayout_g(Context context, AttributeSet attrs, int defStyle) {
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(SlidingPaneLayout_g parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(SlidingPaneLayout_g parent, View child) {
    ...
    class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setClassName(SlidingPaneLayout_g.class.getName());
            info.setSource(host);
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            event.setClassName(SlidingPaneLayout_g.class.getName());
        }
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == SlidingPaneLayout_g.this) {
